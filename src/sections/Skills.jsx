...
export default function Skills() {
  return (
    <section
      id="skills"
      className="max-w-6xl dark:bg-gray-900 mx-auto px-4 sm:px-6 py-20"
    >
      <motion.h2
          ...
          >
            ...
            >
              {skills.map((skill) => (
                <motion.li
                  key={skill}
                  className="cursor-pointer px-3 py-1 rounded-full text-sm font-medium border border-sky-400 text-sky-800 dark:text-sky-200 dark:border-sky-600"
